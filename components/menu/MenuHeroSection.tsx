...
export default function MenuHeroSection({ page }: { page?: WebsitePageRecord | null }) {
  const heroEyebrow = page?.heroEyebrow || "Discover";
  const heroTitle = page?.heroTitle || "Menu";
