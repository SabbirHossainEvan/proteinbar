...
import MonthlyPlanSelectedMealsSummary from "@/components/monthly-plan/MonthlyPlanSelectedMealsSummary";
  ...
  return (
    <>
          ...
          <div className="relative z-10 flex min-h-[48vh] items-center justify-center px-6 pt-24 text-center text-white">
            <div>
              ...
              <p className="mt-3 text-sm text-white/85 sm:text-base">
                Review the meals you selected before checkout
              </p>
      ...
      {!isLoading && matchedPlan ? (
        <MonthlyPlanSelectedMealsSummary
          plan={matchedPlan}
          selection={selection}
