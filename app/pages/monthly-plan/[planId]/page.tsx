...
export default function MonthlyPlanDetailsPage() {
  ...
  if (isLoading) {
    return <section className="py-10">Loading plan...</section>;
  }

  if (!plan) {
    return <section className="py-10">Plan not found.</section>;
  }
    ...
    <>
      <section className="relative left-1/2 right-1/2 -mx-[50vw] -mt-8 w-screen overflow-hidden sm:-mt-10">
        <div className="relative min-h-[58vh] w-full">
          <Image src="/location_hero.png" alt={plan.title} fill priority className="object-cover" />
