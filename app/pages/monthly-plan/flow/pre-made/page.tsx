    ...
    <>
      <section className="relative left-1/2 right-1/2 -mx-[50vw] -mt-8 w-screen overflow-hidden sm:-mt-10">
        <div className="relative min-h-[48vh] w-full">
          <Image src="/location_hero.png" alt="Pre-made plans" fill priority className="object-cover" />
          ...
          <div className="relative z-10 flex min-h-[48vh] items-center justify-center px-6 pt-24 text-center text-white">
            <div>
              <p className="text-xs uppercase tracking-[0.28em] text-white/70">Flow 2</p>
              <h1 className="mt-3 text-4xl font-semibold tracking-tight sm:text-5xl lg:text-7xl">Pre-made Plan Categories</h1>
              ...
              <p className="mt-8 text-sm text-white/90">
                ...
                <Link href="/plans" className="hover:text-white">Monthly Plans</Link> <span className="px-1">{">"}</span>
        ...
        <div className="grid gap-5 sm:grid-cols-2 xl:grid-cols-3">
          {preMadePlans.map((plan) => (
            ...
            >
              ...
              <h2 className="mt-6 text-center text-6xl font-semibold leading-[1.05] tracking-tight text-zinc-900">{plan.title}</h2>
